...
set CLASSPATH=%APP_HOME%\lib\apex-ast-serializer-1.0-SNAPSHOT.jar;%APP_HOME%\lib\apex-jorje-lsp.jar;%APP_HOME%\lib\xstream-1.4.17.jar;%APP_HOME%\lib\jersey-media-json-jackson-3.0.2.jar;%APP_HOME%\lib\jaxb-api-2.3.1.jar;%APP_HOME%\lib\slf4j-simple-1.7.31.jar;%APP_HOME%\lib\jersey-container-jetty-http-3.0.2.jar;%APP_HOME%\lib\jetty-servlet-11.0.5.jar;%APP_HOME%\lib\jetty-security-11.0.5.jar;%APP_HOME%\lib\jetty-server-11.0.5.jar;%APP_HOME%\lib\jetty-http-11.0.5.jar;%APP_HOME%\lib\jetty-io-11.0.5.jar;%APP_HOME%\lib\jetty-util-11.0.5.jar;%APP_HOME%\lib\slf4j-api-2.0.0-alpha1.jar;%APP_HOME%\lib\jersey-container-servlet-core-3.0.2.jar;%APP_HOME%\lib\jersey-server-3.0.2.jar;%APP_HOME%\lib\jersey-hk2-3.0.2.jar;%APP_HOME%\lib\commons-cli-1.4.jar;%APP_HOME%\lib\commons-io-2.10.0.jar;%APP_HOME%\lib\mxparser-1.2.1.jar;%APP_HOME%\lib\javax.activation-api-1.2.0.jar;%APP_HOME%\lib\jetty-jakarta-servlet-api-5.0.2.jar;%APP_HOME%\lib\jersey-client-3.0.2.jar;%APP_HOME%\lib\jersey-common-3.0.2.jar;%APP_HOME%\lib\jersey-entity-filtering-3.0.2.jar;%APP_HOME%\lib\jakarta.ws.rs-api-3.0.0.jar;%APP_HOME%\lib\jakarta.annotation-api-2.0.0.jar;%APP_HOME%\lib\hk2-locator-3.0.1.jar;%APP_HOME%\lib\hk2-api-3.0.1.jar;%APP_HOME%\lib\hk2-utils-3.0.1.jar;%APP_HOME%\lib\jakarta.inject-api-2.0.0.jar;%APP_HOME%\lib\jakarta.validation-api-3.0.0.jar;%APP_HOME%\lib\jackson-core-2.12.2.jar;%APP_HOME%\lib\jackson-module-jaxb-annotations-2.12.2.jar;%APP_HOME%\lib\jackson-databind-2.12.2.jar;%APP_HOME%\lib\jackson-annotations-2.12.2.jar;%APP_HOME%\lib\javassist-3.25.0-GA.jar;%APP_HOME%\lib\xmlpull-1.1.3.1.jar;%APP_HOME%\lib\osgi-resource-locator-1.0.3.jar;%APP_HOME%\lib\aopalliance-repackaged-3.0.1.jar
