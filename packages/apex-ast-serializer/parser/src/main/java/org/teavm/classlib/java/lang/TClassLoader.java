...
public abstract class TClassLoader extends TObject {
  ...
  private static TSystemClassLoader systemClassLoader =
    new TSystemClassLoader();
  ...
  public static TClassLoader getPlatformClassLoader() {
    return systemClassLoader;
  }
  ...
  @JSBody(
    params = "resource",
    script = "return resource !== null && resource !== void 0 ? resource : null;"
  )
