...
| `apexListMultiline`      | `false`     | Whether to format list literals with multiple entries across multiple lines.                                                                                                                                                                                   |
| `apexMapMultiline`       | `false`     | Whether to format map literals with multiple entries across multiple lines.                                                                                                                                                                                      |
